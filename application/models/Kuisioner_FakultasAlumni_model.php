...
class Kuisioner_FakultasAlumni_model extends CI_Model
{
    ...
    public function getKuisAlumni($limit, $start, $keyword = null)
    {
        ...
        return $this->db->get('kuisioner_fakultas_alumni', $limit, $start)->result_array();
    }

    public function countAllKuisAlumni()
    {
        return $this->db->get('kuisioner_fakultas_alumni')->num_rows();
    }
    ...
    public function tambahDataKuisAlumniTipeA()
    {
        ...
        $this->db->insert('kuisioner_fakultas_alumni', $data);
    }
    ...
    {
        $this->db->where('id', $id);
        $this->db->delete('kuisioner_fakultas_alumni');
    }

    public function getKuisAlumniById($id)
    {
        return $this->db->get_where('kuisioner_fakultas_alumni', ['id' => $id])->row_array();
    }

    public function getKuisAlumniDgId($id)
    {
        return $this->db->get_where('kuisioner_fakultas_alumni', ['id' => $id])->result_array();
    }
    ...
    public function ubahDataKuisAlumniTipeA()
    {
        ...
        $this->db->update('kuisioner_fakultas_alumni', $data);
    }
