...
class Grup_Model extends CI_Model
{
    ...
    public function getGrup($limit, $start, $keyword = null)
    {
        ...
        return $this->db->get('grup_kuisioner', $limit, $start)->result_array();
    }

    public function countAllGrup()
    {
        return $this->db->get('grup_kuisioner')->num_rows();
    }
    ...
    public function tambahGrupKuisioner()
    {
        ...
        $this->db->insert('grup_kuisioner', $data);
    }

    public function hapusGrupKuisioner($id_grup)
    {
        $this->db->where('id_grup', $id_grup);
        $this->db->delete('grup_kuisioner');
    }

    public function getGrupById($id_grup)
    {
        return $this->db->get_where('grup_kuisioner', ['id_grup' => $id_grup])->row_array();
    }
    ...
    public function ubahGrupKuisioner()
    {
        ...
        $this->db->update('grup_kuisioner', $data);
    }
}
