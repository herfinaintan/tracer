            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        <input type="hidden" name="id_grup" value="<?= $grup_kuisioner_fakultas['id_grup'];?>">
                        <div class="form-group">
                            <label for="nama">Nama Grup Kuisioner</label>
                            <input type="text" class="form-control" id="nama_grup" name="nama_grup" value="<?= $grup_kuisioner_fakultas['nama_grup']; ?>">
